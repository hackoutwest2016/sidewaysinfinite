...
public class EAlbumsForArtistRequest extends EAbstractRequest {

  public EAlbumsForArtistRequest(Builder builder) {
    super(builder);
  }
  ...
  public static final class Builder extends EAbstractRequest.Builder<Builder> {
    ...
    public EAlbumsForArtistRequest build() {
      return new EAlbumsForArtistRequest(this);
    }
