...
public class EPlaylistTracksRequest extends EAbstractRequest {

  public EPlaylistTracksRequest(Builder builder) {
    super(builder);
  }
  ...
  public static final class Builder extends EAbstractRequest.Builder<Builder> {
    ...
    public EPlaylistTracksRequest build() {
      return new EPlaylistTracksRequest(this);
    }
