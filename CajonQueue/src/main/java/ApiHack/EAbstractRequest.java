...
public abstract class EAbstractRequest implements ERequest {
  ...
  public EAbstractRequest(Builder<?> builder) {
    ...
    if (builder.httpManager == null) {
      httpManager = ExtendedSpotifyApi.DEFAULT_HTTP_MANAGER;
    } else {
  ...
  public static abstract class Builder<BuilderType extends Builder<?>> implements ERequest.Builder {

    protected Url.Scheme scheme = ExtendedSpotifyApi.DEFAULT_SCHEME;
    protected String host = ExtendedSpotifyApi.DEFAULT_HOST;
    protected int port = ExtendedSpotifyApi.DEFAULT_PORT;
